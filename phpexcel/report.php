<?php
require_once('../php/inc_excel.php');

//var_dump($_SESSION["iid"]);die();
$merchantname = getUserMerchantName($_SESSION["iid"]);
$merchantaddress1 = '2235 East Flamingo Road';
$merchantaddress2 = 'Suite 100-D';
...
$objPHPExcel->getActiveSheet()->getStyle('H15:H18')->getNumberFormat()->applyFromArray(
 ...
 $objPHPExcel->getActiveSheet()->getStyle('j15:j18')->getNumberFormat()->applyFromArray(
  ...
  $objPHPExcel->getActiveSheet()->getStyle('J21')->getNumberFormat()->applyFromArray(
         array(
             'code' => PHPExcel_Style_NumberFormat::FORMAT_CURRENCY_USD_SIMPLE
         )
 );
  $objPHPExcel->getActiveSheet()->getStyle('K21')->getNumberFormat()->applyFromArray(
         array(
             'code' => PHPExcel_Style_NumberFormat::FORMAT_CURRENCY_USD_SIMPLE
         )
 );
   $objPHPExcel->getActiveSheet()->getStyle('H21')->getNumberFormat()->applyFromArray(
         array(
             'code' => PHPExcel_Style_NumberFormat::FORMAT_CURRENCY_USD_SIMPLE
         )
 );
    $objPHPExcel->getActiveSheet()->getStyle('D21')->getNumberFormat()->applyFromArray(
         array(
             'code' => PHPExcel_Style_NumberFormat::FORMAT_CURRENCY_USD_SIMPLE
         )
 );
     $objPHPExcel->getActiveSheet()->getStyle('F21')->getNumberFormat()->applyFromArray(
         array(
             'code' => PHPExcel_Style_NumberFormat::FORMAT_CURRENCY_USD_SIMPLE
         )
 );
